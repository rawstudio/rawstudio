...
#define rs_image16_scale(in, out, scale) rs_image16_scale_affine(in, out, scale)
...
RS_IMAGE16 *rs_image16_scale_affine(RS_IMAGE16 *in, RS_IMAGE16 *out, gdouble scale);
