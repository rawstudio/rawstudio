...
{
	rs_filetype_register_loader(".arw", "Sony", load_rawspeed, 5, RS_LOADER_FLAGS_RAW);
	...
	rs_filetype_register_loader(".raw", "Panasonic raw v1", load_rawspeed, 5, RS_LOADER_FLAGS_RAW);
