...
/*
  Modified for use in Rawstudio by Anders Brander 
 */
 ...
 * @return A null-terminated string of 32 characters
 */
char *
rs_md5(const char *str)
{
	char *ret;
	md5_state_t state;
	md5_byte_t digest[16];
	...
	sprintf(ret, "%08x%08x%08x%08x", d[0], d[1], d[2], d[3]);
