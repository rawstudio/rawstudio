...
gboolean gui_tool_rgb_mixer_r_callback(GtkAdjustment *caller, RS_BLOB *rs);
gboolean gui_tool_rgb_mixer_g_callback(GtkAdjustment *caller, RS_BLOB *rs);
gboolean gui_tool_rgb_mixer_b_callback(GtkAdjustment *caller, RS_BLOB *rs);
GtkWidget *gui_tool_rgb_mixer(RS_BLOB *rs);
gboolean gui_tool_warmth_w_callback(GtkAdjustment *caller, RS_BLOB *rs);
gboolean gui_tool_warmth_t_callback(GtkAdjustment *caller, RS_BLOB *rs);
GtkWidget *gui_tool_warmth(RS_BLOB *rs);
...
gboolean gui_tool_saturation_callback(GtkAdjustment *caller, RS_BLOB *rs);
GtkWidget *gui_tool_saturation(RS_BLOB *rs);
gboolean gui_tool_hue_callback(GtkAdjustment *caller, RS_BLOB *rs);
GtkWidget *gui_tool_hue(RS_BLOB *rs);
gboolean gui_tool_contrast_callback(GtkAdjustment *caller, RS_BLOB *rs);
